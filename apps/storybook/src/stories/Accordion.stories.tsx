    ...
    render: () => (
        <Accordion className="w-full max-w-md">
            <AccordionItem value="item-1">
                ...
                <AccordionContent>
                    Yes. It adheres to the WAI-ARIA design pattern and uses Base
                    UI under the hood.
                </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3">
                ...
                <AccordionContent>
                    Yes. The content panel animates open and closed using CSS
                    transitions.
                </AccordionContent>
            </AccordionItem>
        </Accordion>
    ...
    render: () => (
        <Accordion className="w-full max-w-md" defaultValue={['item-1']}>
            <AccordionItem value="item-1">
                ...
                <AccordionContent>This panel is open on first
